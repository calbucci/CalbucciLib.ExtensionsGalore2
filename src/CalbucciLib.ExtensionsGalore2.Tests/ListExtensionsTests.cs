...
namespace CalbucciLib.ExtensionsGalore2.Tests
{
    ...
    public class ListExtensionsTests
    {
        ...
        public void RandomizeTest()
        {
            ...
            Assert.IsTrue(original.IsEqualSet(randomized));
        ...
        public void DeepCopyTest()
        {
            ...
            for (int i = 0; i < original.Count; i++)
            {
                ...
                else
                {
                    ...
                    if(objOriginal!.GetType() != typeof(string))
        ...
        public void IsEqualSetTest()
        {
            ...
            for (int i = 0; i < testsEqual.Count; i += 2)
            {
                ...
                Assert.IsTrue(list1.IsEqualSet(list2));
                Assert.IsTrue(list2.IsEqualSet(list1));
                Assert.IsTrue(list1.IsEqualSet(list1));
            }
            ...
            for (int i = 0; i < testsNotEqual.Count; i += 2)
            {
                ...
                Assert.IsFalse(list1.IsEqualSet(list2));
                Assert.IsFalse(list2.IsEqualSet(list1));
            }
