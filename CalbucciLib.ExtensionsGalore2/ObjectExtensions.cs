...
namespace CalbucciLib.ExtensionsGalore
{
    public static class ObjectExtensions
    {
        ...
        {
            if (_fieldMap.TryGetValue(type, out FieldInfo[]? fields))
            {
                return fields;
            }
        ...
        public static object? DeepCopy(this object? obj, bool preferICloneable = false)
        {
            ...
            if (stringObj != null)
            {
                // https://github.com/dotnet/runtime/issues/27515
                return stringObj;
            }
            ...
            {
                var newObject = Activator.CreateInstance(type);
                var newList = newObject as IList;
                if (newList != null)
                {
            ...
            if (type.IsGenericType)
            {
                ...
                // TODO: Support new Tuple syntax as well
            ...
            if (dictionary != null)
            {
                ...
                foreach (var key in dictionary.Keys)
                {
                    ...
                    newObject.Add(keyCopy, valueCopy);
                }
                return newObject;
            }
