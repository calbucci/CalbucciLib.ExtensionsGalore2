...
This library is only available for .NET 6.0 or later.

## Awesomeness in a box

- Comprehensive DeepCopy functionality
- Tons of extensions for DateTime for those that have a hard time with dates like me.
...
- ExtensionsGalore 2 was originally created by *Marcelo Calbucci* ([calbucci.com](https://calbucci.com) | [@calbucci](http://twitter.com/calbucci))